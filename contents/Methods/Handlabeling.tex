...
The following illustrations \figref{fig:meth:signal}, \figref{fig:meth:unknown}, \figref{fig:meth:walter_white}, \figref{fig:meth:MRI}, \figref{fig:meth:Movement}, \figref{fig:meth:Unoise}, \figref{fig:meth:sus}, \figref{fig:meth:sinus} and \figref{fig:meth:phys} show transverse spatial examples of components related to the various artifact classes, the signal class and the unknown class.
