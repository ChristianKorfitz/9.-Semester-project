\section{Task/Stimuli design} \label{sec:Stim}

The following section will describe different standards of designing experiments where stimuli is used to assess brain activation. The impact of stimuli on the hemodynamic response and how it is prepared for analysis will be further explained, continuing where \secref{sec:fMRI} left of.
